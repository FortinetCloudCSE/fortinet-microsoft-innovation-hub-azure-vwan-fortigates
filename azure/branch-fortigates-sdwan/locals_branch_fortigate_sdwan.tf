locals {
  ...
  subnets = {
    "snet-external" = {
      ...
      address_prefixes     = [cidrsubnet(tolist(azurerm_virtual_network.virtual_network[local.virtual_network_name].address_space)[0], 6, 0)]
    }
    "snet-internal" = {
      resource_group_name = azurerm_resource_group.resource_group[local.resource_group_name].name
      ...
      name                 = "snet-internal"
      virtual_network_name = azurerm_virtual_network.virtual_network[local.virtual_network_name].name
      address_prefixes     = [cidrsubnet(tolist(azurerm_virtual_network.virtual_network[local.virtual_network_name].address_space)[0], 6, 1)]
    }
    "snet-hasync" = {
      resource_group_name = azurerm_resource_group.resource_group[local.resource_group_name].name
      ...
      name                 = "snet-hasync"
      virtual_network_name = azurerm_virtual_network.virtual_network[local.virtual_network_name].name
      address_prefixes     = [cidrsubnet(tolist(azurerm_virtual_network.virtual_network[local.virtual_network_name].address_space)[0], 6, 2)]
    }
    "snet-mgmt" = {
      resource_group_name = azurerm_resource_group.resource_group[local.resource_group_name].name
      ...
      name                 = "snet-mgmt"
      virtual_network_name = azurerm_virtual_network.virtual_network[local.virtual_network_name].name
      address_prefixes     = [cidrsubnet(tolist(azurerm_virtual_network.virtual_network[local.virtual_network_name].address_space)[0], 6, 3)]
    }
    "snet-protected" = {
      resource_group_name = azurerm_resource_group.resource_group[local.resource_group_name].name
      ...
      ip_configurations = [
        {
          ...
          public_ip_address_id          = azurerm_public_ip.public_ip["pip-fgt-1-mgmt"].id
        }
      ]
    }
    "nic-fortigate_2_1" = {
      ...
      ip_configurations = [
        {
          ...
          public_ip_address_id          = azurerm_public_ip.public_ip["pip-fgt-2-mgmt"].id
        }
      ]
    }
  }
      ...
      frontend_ip_configurations = [
        {
          ...
          subnet_id                     = azurerm_subnet.subnet["snet-internal"].id
          vnet_name                     = azurerm_virtual_network.virtual_network[local.virtual_network_name].name
    ...
    "vm_fgt_1" = {
      ...
      os_profile_custom_data = templatefile(
        "templates/fortios_config.conf", {
          ...
          vnet_address_prefix     = tolist(azurerm_virtual_network.virtual_network[local.virtual_network_name].address_space)[0]
